...
class MybatisRuntimeHintsRegistrar implements RuntimeHintsRegistrar {
    ...
    private void registerGlobalTypeHints(RuntimeHints hints) {
        var caches = Set.of(Cache.class, LruCache.class, BlockingCache.class, SerializedCache.class, FifoCache.class,
                NullCacheKey.class, PerpetualCache.class, CacheKey.class, WeakCache.class, TransactionalCache.class, SynchronizedCache.class, LoggingCache.class
        );
        var collections = Set.of(AbstractList.class,
                List.class, RandomAccess.class, Cloneable.class,
                Collection.class, TreeSet.class, SortedSet.class, Iterator.class,
                ArrayList.class, HashSet.class, Set.class, Map.class);
        ...
        classesForReflection.addAll(Set.of(
                java.io.Serializable.class,
                // caching
                PerpetualCache.class,
                Cursor.class, Optional.class,
                LruCache.class,
                MethodHandles.class,
                ...
                //
                RawLanguageDriver.class, Configuration.class, String.class, int.class,
